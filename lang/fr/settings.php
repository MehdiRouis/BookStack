...
return [
    ...
    'bookshelf_color' => 'Couleur des thématiques',
    'book_color' => 'Couleur des modules',
    ...
    // Sorting Settings
    'sorting' => 'Tri',
    'sorting_book_default' => 'Tri des modules par défaut',
    'sorting_book_default_desc' => 'Sélectionnez le tri par défaut à mettre en place sur les nouveaux modules. Cela n’affectera pas les modules existants, et peut être redéfini dans les modules.',
    ...
    'sort_rule_assigned_to_x_books' => 'Assignée à :count module|Assignée à :count modules',
    ...
    'sort_rule_delete_desc' => 'Supprimer cette règle du système. Les modules l’utilisant précédemment reviendront au tri manuel.',
    'sort_rule_delete_warn_books' => 'Cette règle est actuellement utilisée par :count module(s). Êtes-vous sûr·e de vouloir la supprimer ?',
    'sort_rule_delete_warn_default' => 'Cette règle est actuellement utilisée par défaut pour les modules. Êtes-vous sûr·e de vouloir la supprimer ?',
    ...
    'maint_recycle_bin_desc' => 'Les thématiques, modules, chapitres et pages supprimés sont envoyés dans la corbeille afin qu\'ils puissent être restaurés ou supprimés définitivement. Les éléments plus anciens de la corbeille peuvent être supprimés automatiquement après un certain temps selon la configuration du système.',
    ...
    'role_manage_entity_permissions' => 'Gérer les permissions sur les modules, chapitres et pages',
    'role_manage_own_entity_permissions' => 'Gérer les permissions de ses propres modules, chapitres et pages',
    ...
    'role_asset_desc' => 'Ces permissions contrôlent l\'accès par défaut des ressources dans le système. Les permissions dans les modules, les chapitres et les pages ignoreront ces permissions',
