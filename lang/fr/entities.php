...
return [
    ...
    'recently_created_shelves' => 'Thématiques créées récemment',
    ...
    'import_desc' => 'Importez des Modules, des chapitres et des pages à l\'aide d\'un export zip à partir de la même instance ou d\'une instance différente. Sélectionnez un fichier ZIP pour continuer. Une fois le fichier téléchargé et validé, vous pourrez configurer et confirmer l\'importation dans la vue suivante.',
    ...
    'permissions_book_cascade' => 'Les permissions définies sur les Modules seront automatiquement mises en cascade dans les chapitres enfants et les pages, à moins qu\'elles aient leurs propres permissions définies.',
    ...
    'shelf' => 'Thématique',
    'shelves' => 'Thématiques',
    'x_shelves' => ':count Thématique|:count Thématiques',
    'shelves_empty' => 'Aucune Thématique n\'a été créée',
    'shelves_create' => 'Créer une nouvelle Thématique',
    'shelves_popular' => 'Thématiques populaires',
    'shelves_new' => 'Nouvelles Thématiques',
    'shelves_new_action' => 'Nouvelle Thématique',
    'shelves_popular_empty' => 'Les Thématiques les plus populaires apparaîtront ici.',
    'shelves_new_empty' => 'Les Thématiques les plus récentes apparaitront ici.',
    'shelves_save' => 'Enregistrer l\'Thématique',
    'shelves_books' => 'Modules sur cette Thématique',
    'shelves_add_books' => 'Ajouter des Modules sur cette Thématique',
    'shelves_drag_books' => 'Déposez des Modules ici pour les ajouter a cette Thématique',
    'shelves_empty_contents' => 'Aucun Module n\'a été assigné à cette Thématique',
    'shelves_edit_and_assign' => 'Modifier cette Thématique pour y ajouter des Modules',
    'shelves_edit_named' => 'Modifier l\'Thématique :name',
    'shelves_edit' => 'Modifier l\'Thématique',
    'shelves_delete' => 'Supprimer l\'Thématique',
    'shelves_delete_named' => 'Supprimer l\'Thématique :name',
    'shelves_delete_explain' => "Ceci va supprimer l'Thématique nommée ':name'. Les Modules contenus dans cette Thématique ne seront pas supprimés.",
    'shelves_delete_confirmation' => 'Êtes-vous sûr(e) de vouloir supprimer cette Thématique ?',
    'shelves_permissions' => 'Enregistrer les permissions',
    'shelves_permissions_updated' => 'Permissions de l\'Thématique mises à jour',
    'shelves_permissions_active' => 'Permissions de l\'Thématique activées',
    'shelves_permissions_cascade_warning' => 'Les permissions sur les Thématiques ne sont pas automatiquement recopiées aux Modules qu\'elles contiennent, car un Module peut exister dans plusieurs Thématiques. Les permissions peuvent cependant être recopiées vers les Modules contenus en utilisant l\'option ci-dessous.',
    'shelves_permissions_create' => 'Les permissions de création d\'une Thématique sont uniquement utilisées pour copier les permissions vers les Modules enfants en utilisant l\'action ci-dessous. Elles ne contrôlent pas la possibilité de créer des Modules.',
    'shelves_copy_permissions_to_books' => 'Copier les permissions vers les Modules',
    'shelves_copy_permissions' => 'Copier les permissions',
    'shelves_copy_permissions_explain' => 'Ceci va appliquer les permissions actuelles de cette Thématique à tous les Modules qu\'elle contient. Avant de continuer, assurez-vous que toutes les permissions de cette Thématique ont été sauvegardées.',
    'shelves_copy_permission_success' => 'Permissions de l\'Thématique transférées à :count Modules',
    ...
    'books_delete_explain' => 'Ceci va supprimer le Module nommé \':bookName\', tous les chapitres et pages seront supprimés.',
    ...
    'books_empty_contents' => 'Aucune page ou chapitre n\'a été ajouté à ce Module.',
    'books_empty_create_page' => 'Créer une nouvelle page',
    'books_empty_sort_current_book' => 'Trier les pages du Module',
    ...
    'pages_delete_warning_template' => 'Cette page actuellement utilisée comme modèle de page par défaut de Module ou de chapitre. Ces Modules ou chapitres n\'auront plus de modèle de page par défaut assigné après la suppression de cette page.',
    ...
    'shelf_tags' => 'Mots-clés de l\'Thématique',
    'tag' => 'Mot-clé',
    'tags' =>  'Mots-clés',
    ...
    'tags_assigned_shelves' => 'Attribuer aux Thématiques',
    ...
    'tags_list_empty_hint' => 'Les mots-clés peuvent être assignés via la barre latérale de l\'éditeur de page ou lors de l\'édition des détails d\'un Module, d\'un chapitre ou d\'une Thématique.',
    ...
    'profile_not_created_shelves' => ':userName n\'a pas créé d\'Thématique',
    ...
    // Conversions
    'convert_to_shelf' => 'Convertir en Thématique',
    'convert_to_shelf_contents_desc' => 'Vous pouvez convertir ce Module en une nouvelle Thématique avec le même contenu. Les chapitres contenus dans ce Module seront convertis en nouveaux Modules. Si ce Module contient des pages, qui ne sont pas dans un chapitre, ce Module sera renommé et contiendra ces pages, et ce Module fera partie de la nouvelle Thématique.',
    'convert_to_shelf_permissions_desc' => 'Toutes les autorisations définies sur ce Module seront copiées sur la nouvelle Thématique et sur tous les nouveaux Modules enfants qui n\'ont pas leurs propres permissions appliquées. Notez que les permissions sur les Thématiques ne font pas automatiquement cascade au contenu intérieur, comme elles le font pour les Modules.',
    ...
    'convert_to_book_desc' => 'Vous pouvez convertir ce chapitre en un nouveau Module avec le même contenu. Toutes les permissions définies dans ce chapitre seront copiées dans le nouveau Module mais toutes les permissions héritées du Module parent ne seront pas copiés, ce qui pourrait conduire à un changement de contrôle d\'accès.',
